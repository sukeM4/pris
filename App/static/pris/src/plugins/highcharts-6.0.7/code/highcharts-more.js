    ...
    a.radialAxisExtended ||
      ...
      (f = {
        ...
        getPosition: function (b, c) {
          return this.postTranslate(
            ...
            e(this.isCircular ? c : this.translate(b), this.center[2] / 2) -
              this.offset
          );
        },
      ...
      b(k, "init", function (b, a, g) {
        ...
        !u &&
          ...
          (this.endAngleRad =
            ((e(h.endAngle, h.startAngle + 360) - 90) * Math.PI) / 180),
        ...
        translate: function () {
          ...
          r(b.points, function (f) {
            ...
            null === d || null === g
              ...
              : ((f.plotLow = m),
                (f.plotHigh = c.translate(
                  a ? b.modifyValue(d, f) : d,
                  0,
                  1,
                  0,
                  1
        ...
        translate: function () {
          ...
          v(b.points, function (f) {
            var q = f.shapeArgs,
              ...
              h,
              n;
            f.plotHigh = l = Math.min(
              Math.max(-u, c.translate(f.high, 0, 1, 0, 1)),
              u
            );
            ...
            m
              ? ((g = f.barX + k),
                (f.shapeType = "path"),
                (f.shapeArgs = {
                  d: b.polarArc(n + h, n, g, g + f.pointWidth),
                }))
              : ((q.height = h),
                (q.y = n),
            ...
            (g = k[f]),
              ...
              g.isSum
                ? ((d.y = a.translate(n[1], 0, 1, 0, 1)),
                  (d.height =
                    Math.min(a.translate(n[0], 0, 1, 0, 1), a.len) - d.y))
                : g.isIntermediateSum
                ? ((d.y = a.translate(n[1], 0, 1, 0, 1)),
                  (d.height =
                    Math.min(a.translate(p, 0, 1, 0, 1), a.len) - d.y),
                  (p = n[1]))
                : ((d.height =
                    0 < l
  ...
  (function (a) {
    ...
    v(
      ...
      },
      {
        ...
        getGraphPath: function () {
          for (
            var a = r.prototype.getGraphPath.call(this), p = a.length + 1;
            p--;
  ...
  (function (a) {
    ...
    if (!a.polarExtended) {
      ...
      p.searchPointByAngle = function (b) {
        ...
        return this.searchKDTree({
          clientX:
            ...
            (-180 / Math.PI) *
              Math.atan2(
                b.chartX - f[0] - a.plotLeft,
                b.chartY - f[1] - a.plotTop
              ),
        });
      };
      ...
      p.toXY = function (b) {
        ...
        this.kdByAngle
          ? ((f =
              ((k / Math.PI) * 180 + this.xAxis.pane.options.startAngle) % 360),
            0 > f && (f += 360),
            (b.clientX = f))
          : (b.clientX = b.plotX);
      };
      ...
      a.addEvent(p, "afterTranslate", function () {
        ...
        if (b.polar) {
          ...
          this.hasClipCircleSetter ||
            (this.hasClipCircleSetter = !!a.addEvent(
              this,
              "afterRender",
              function () {
                var c;
